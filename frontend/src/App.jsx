...
import { connectWS } from './ws'; // make sure this file exists and exports connectWS
  ...
  useEffect(() => {
    ...
    socket.current.on('connect', () => {
      socket.current.on('roomNotice', (name) => {
        console.log(`${name} joined to group!`);
      });
      ...
      socket.current.on('oldMessages', (msgs) => {
        setMessages(msgs);
      });
    ...
    return () => {
      ...
      socket.current.off('oldMessages');
        ...
        <div className="w-full max-w-2xl h-[90vh] bg-white rounded-xl shadow-md flex flex-col overflow-hidden">
          ...
          <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200">
            ...
            <div className="flex-1">
              ...
              {typers.length > 0 && <div className="text-xs text-gray-500">{typers.join(', ')} is typing...</div>}
            </div>
